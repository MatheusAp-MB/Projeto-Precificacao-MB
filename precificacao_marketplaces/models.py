# * [RESUMO] → Models do app de precificação por marketplace.
...
# * [EXPLICAÇÃO] → Cada linha dessa tabela representa UMA célula da matriz de frete.
#*                 A matriz tem faixas de peso nas linhas e faixas de preço nas colunas.
#*                 Exemplo de uma linha:
#*                   peso_min=0.000, peso_max=0.300, preco_min=0.00, preco_max=79.99, valor=12.50
#*                 Significa: produto até 300g vendido até R$79,99 → frete custa R$12,50
...
class FreteML(models.Model):
    ...
    class Meta:
        ...
        #                  Garante que a tabela sempre apareça na ordem correta.
